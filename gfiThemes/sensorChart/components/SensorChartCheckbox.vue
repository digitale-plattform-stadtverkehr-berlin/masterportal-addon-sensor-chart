...
export default {
    ...
    computed: {
        diagramLabel: function () {
            return this.$t("additional:modules.tools.gfi.themes.sensorChart.diagramLabel");
        },

        tableLabel: function () {
            return this.$t("additional:modules.tools.gfi.themes.sensorChart.tableLabel");
        },
