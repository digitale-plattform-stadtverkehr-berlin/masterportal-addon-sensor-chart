...
import sensorChartFooter from "../../../components/SensorChartFooter.vue";
...
describe("addons/sensorChart/components/sensorChartFooter.vue", () => {
    let wrapper;
    const dummyApi = {
    ...
    beforeEach(() => {
        wrapper = shallowMount(sensorChartFooter, {
            propsData: {
                currentTabId: "infos",
                api: dummyApi,
                thingId: 5508,
