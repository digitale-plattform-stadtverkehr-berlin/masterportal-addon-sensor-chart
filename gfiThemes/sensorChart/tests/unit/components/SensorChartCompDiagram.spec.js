...
import SensorChartCompDiagram from "../../../components/SensorChartCompDiagram.vue";
...
describe("addons/sensorChart/components/SensorChartCompDiagram.vue", () => {
    ...
    beforeEach(() => {
        wrapper = shallowMount(SensorChartCompDiagram, {
            localVue,
            propsData: {
