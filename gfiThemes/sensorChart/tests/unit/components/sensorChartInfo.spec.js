...
import sensorChartInfo from "../../../components/SensorChartInfo.vue";
...
describe("addons/sensorChart/components/TraffiCountInfo.vue", () => {
    let wrapper;
    const dummyApi = {
    ...
    beforeEach(() => {
        wrapper = shallowMount(sensorChartInfo, {
            propsData: {
                api: dummyApi,
                thingId: 5508,
