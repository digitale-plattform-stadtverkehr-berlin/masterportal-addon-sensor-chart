...
import SensorChartCompTable from "../../../components/SensorChartCompTable.vue";

const localVue = createLocalVue();

localVue.use(Vuex);

describe("addons/sensorChart/components/SensorChartCompTable.vue", () => {
    let wrapper;

    beforeEach(() => {
        wrapper = shallowMount(SensorChartCompTable, {
            localVue,
            propsData: {
                apiData: [
                    {
