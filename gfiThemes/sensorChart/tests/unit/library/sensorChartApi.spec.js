...
describe("addons/sensorChart/components/sensorChartApi.js", function () {
    describe("SensorChartApi.constructor", function () {
        describe("SensorThingsHttp", function () {
            it("should take the given dummy instead of creating a new instance of SensorThingsHttp", function () {
                const api = new SensorChartApi("httpHost", "sensorThingsVersion", "mqttOptions", "foo", "sensorThingsMqttOpt", "noSingletonOpt");
            ...
            it("should create a new instance of SensorThingsHttp on construction if no dummy was given", function () {
                const api = new SensorChartApi("httpHost", "sensorThingsVersion", "mqttOptions", false, "sensorThingsMqttOpt", "noSingletonOpt");
        ...
        describe("SensorThingsMqtt", function () {
            it("should take the given dummy instead of creating a new instance of SensorThingsMqtt", function () {
                const api = new SensorChartApi("httpHost", "sensorThingsVersion", "mqttOptions", "sensorThingsHttpOpt", "foo", "noSingletonOpt");
        ...
        describe("baseUrlHttp", function () {
            it("should set the base url for http calls correctly at construction", function () {
                const api = new SensorChartApi("https://www.example.com/foo", "version1234", "mqttOptions", "sensorThingsHttpOpt", "sensorThingsMqttOpt", "noSingletonOpt");
        ...
        describe("subscriptionTopics", function () {
            it("should set the subscription topics as an empty object at time of construction", function () {
                const api = new SensorChartApi("httpHost", "sensorThingsVersion", "mqttOptions", "sensorThingsHttpOpt", "sensorThingsMqttOpt", "noSingletonOpt");
        ...
        describe("SensorThingsMqttClient", function () {
            it("should set the on message event with an event", function () {
                ...
                new SensorChartApi("httpHost", "sensorThingsVersion", "mqttOptions", "sensorThingsHttpOpt", dummySensorThingsMqtt, "noSingletonOpt");
            ...
            it("should set the on message event with an event(topic, payload) that will give payload to all callbacks stored in subscriptionTopics[topic]", function () {
                ...
                const dummySensorThingsMqtt = {
                    ...
                    api = new SensorChartApi("httpHost", "sensorThingsVersion", "mqttOptions", "sensorThingsHttpOpt", dummySensorThingsMqtt, "noSingletonOpt"),
                    lastPayloads = [];
    ...
    describe("SensorChartApi.checkForObservations", function () {
    ...
    describe("SensorChartApi.sumObservations", function () {
    ...
    describe("SensorChartApi.getFirstDate", function () {
    ...
    describe("SensorChartApi.parsePhenomenonTime", function () {
        const api = new SensorChartApi("httpHost", "sensorThingsVersion", "mqttOptions", "sensorThingsHttpOpt", "sensorThingsMqttOpt", "noSingletonOpt");
    ...
    describe("SensorChartApi.mqttSubscribe", function () {
    ...
    describe("SensorChartApi.updateTitle", function () {
        it("should build a correct url and call it via given http dummy", function () {
            ...
            const dummySensorThingsHttp = {
                ...
                api = new SensorChartApi("httpHost", "sensorThingsVersion", "mqttOptions", dummySensorThingsHttp, "sensorThingsMqttOpt", "noSingletonOpt");
    ...
    describe("SensorChartApi.updateDirection", function () {
        it("should build a correct url and call it via given http dummy", function () {
            let lastOnupdate = false,
                lastOnstart = false,
                lastOncomplete = false,
    ...
    describe("SensorChartApi.updateDay", function () {
        it("should build a correct url and call it via given http dummy", function () {
            let lastOnupdate = false,
                lastOnstart = false,
                lastOncomplete = false,
            ...
            const dummySensorThingsHttp = {
                ...
                api = new SensorChartApi("https://www.example.com", "v1234", {}, dummySensorThingsHttp, true, "noSingletonOpt"),
        ...
        it("should initialize mqtt subscription on topic with given options if the given day equals today", function () {
            ...
            const dummySensorThingsHttp = {
                ...
                api = new SensorChartApi("https://www.example.com", "v1234", {}, dummySensorThingsHttp, dummySensorThingsMqtt, "noSingletonOpt"),
        ...
        it("should call onerror if no observation was found in http response", function () {
            ...
            const dummySensorThingsHttp = {
                ...
                api = new SensorChartApi(false, false, {}, dummySensorThingsHttp, true, "noSingletonOpt");
    ...
    describe("SensorChartApi.updateYear", function () {
        it("should build a correct url and call it via given http dummy", function () {
            let lastOnupdate = false,
                lastOnstart = false,
                lastOncomplete = false,
    ...
    describe("SensorChartApi.updateTotal", function () {
        it("should build a correct url and call it via given http dummy", function () {
            let lastOnupdate = false,
                lastOnstart = false,
                lastOncomplete = false,
    ...
    describe("SensorChartApi.updateHighestWorkloadDay", function () {
        it("should build a correct url and call it via given http dummy", function () {
            let lastOnupdate = false,
                lastOnstart = false,
                lastOncomplete = false,
    ...
    describe("SensorChartApi.updateHighestWorkloadWeek", function () {
        it("should build a correct url and call it via given http dummy", function () {
            let lastOnupdate = false,
                lastOnstart = false,
                lastOncomplete = false,
    ...
    describe("SensorChartApi.updateHighestWorkloadMonth", function () {
        it("should build a correct url and call it via given http dummy", function () {
            let lastOnupdate = false,
                lastOnstart = false,
                lastOncomplete = false,
    ...
    describe("SensorChartApi.updateDataset", function () {
        it("should build a correct url and call it via given http dummy", function () {
            let lastOnupdate = false,
                lastOnstart = false,
                lastOncomplete = false,
        ...
        it("should subscribe via mqtt retain 2 if param until equals today", function () {
            ...
            const dummySensorThingsHttp = {
                ...
                api = new SensorChartApi("https://www.example.com", "v1234", {host: "foobar"}, dummySensorThingsHttp, dummySensorThingsMqtt, "noSingletonOpt"),
                timeSettings = {
                    interval: "interval",
                    from: "2020-03-20",
                    until: "2020-03-20"
    ...
    describe("SensorChartApi.subscribeLastUpdate", function () {
        it("should build a correct url and call it via given http dummy", function () {
            let lastOnupdate = false,
                lastOnstart = false,
                lastOncomplete = false,
    ...
    describe("SensorChartApi.unsubscribeEverything", function () {
        it("should empty subscription topics", function () {
            const api = new SensorChartApi(false, false, {}, true, true, "noSingletonOpt");
        ...
        it("should call unsubscribe on the given mqtt client for each topic found in subscription topics", function () {
            const unsubscribedTopics = [],
                ...
                api = new SensorChartApi(false, false, {}, true, dummySensorThingsMqtt, "noSingletonOpt");
