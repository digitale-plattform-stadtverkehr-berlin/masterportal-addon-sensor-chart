...
describe("addons/sensorChart/components/sensorChartCache", function () {
    let cache = null;

    beforeEach(() => {
        // this sets the cache with a boolean true as api without starting the real api
        // use param sensorChartApiOpt to emulate the api for testing methods calling the api
        cache = new SensorChartCache(null, null, null, true);
    });
